...
/** -------------------------------------------------------------------------------------------------------------------- **
/** -------------------------------------------------------------------------------------------------------------------- **/
json_to(file_get_contents(__ROOT__."/Configs/config.application.params.json"));
json_to(file_get_contents(__ROOT__."/Configs/config.application.credentials.json"));
